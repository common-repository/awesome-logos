<?php
	...
	function logos_slider_adminpage_scripts() {
		...
		if( is_admin() ){
			...
			if ( isset($_GET['page']) && 'awesome-logos-admin' == esc_attr($_GET['page']) ) {
	...
	function wps_logos_update_cfields( $post_id) {
		...
		$slide_link_url_temp= isset($_POST['wps_logo_slide_link'])?esc_attr($_POST['wps_logo_slide_link']):
		'';
		$slide_link_target_temp= isset($_POST['wps_logo_link_target'])?esc_attr($_POST['wps_logo_link_target']):
		'';
		$slide_logo_fetch_temp= isset($_POST['wps_logo_img_url'])? esc_url($_POST['wps_logo_img_url']):
		'';
		$wps_alt_text_temp= isset($_POST['wps_logo_alt_text'])? esc_attr($_POST['wps_logo_alt_text']):
		'';
		#update meta values
