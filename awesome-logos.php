...
/*-----------------------------------------------------------------------
 ...
 # Plugin URI : http://www.wpmars.com/awesome-logos-wordpress-plugin/
 # Description: Awesome Logos to show slider carousel and grids of brands, partners logos or to showcase photos.
 # Version: 1.2
 # Author: WP Mars
 # Author URI: http://www.wpmars.com
 *----------------------------------------------------------------------*/

/**
 * Awesome Logos
 * Copyright (C) 2018, WP Mars - wpmars9@gmail.com
 *
...
function wps_al_remove_footer_admin_text () {
	...
	if ( $wps_screen->post_type == 'wps_logos' ) {
		echo '<span id="footer-thankyou">Developed by <a href="http://www.wpmars.com" target="_blank">WP Mars</a>. | Please rate <a href="https://wordpress.org/support/view/plugin-reviews/awesome-logos?rate=5#postform" target="_blank">Awesome logos</a> | Need help? <a href="http://wpmars.com/contact-us/" target="_blank">Contact us</a></span>';
	}
